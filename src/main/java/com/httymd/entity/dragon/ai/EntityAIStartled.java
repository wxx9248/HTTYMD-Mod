    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            List list = this.dragon.world.getEntitiesWithinAABB(this.avoidClass,
                                                                this.dragon.getEntityBoundingBox()
                                                                           .expand(this.reactDist, this.reactDist * 0.4,
                                                                                   this.reactDist));
        ...
        Vec3d vec3 = RandomPositionGenerator.findRandomTargetBlockAwayFrom(this.dragon, 16, 7,
                                                                           new Vec3d(this.closestLiving.getPosition()
                                                                                                       .up()));
        ...
        else
        {
            ...
            return this.entityPathEntity != null && this.entityPathEntity.getCurrentPos().equals(vec3);
        }
    }
