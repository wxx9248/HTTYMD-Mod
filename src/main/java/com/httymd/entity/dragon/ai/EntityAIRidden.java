...
public class EntityAIRidden extends EntityAIBase {
	...
	public boolean shouldExecute() {
		if (this.riddenEntity.getRidingEntity() != null && this.riddenEntity.getRidingEntity() instanceof EntityLivingBase) {
	...
	public void updateTask() {
		...
		if (this.riddenEntity instanceof EntityDragon) {
			...
			if (!draco.isFlying()) {
				if (this.rider.getHeldItemMainhand() != null && this.rider.getHeldItemMainhand().getItem() == ItemRegistry.wing
