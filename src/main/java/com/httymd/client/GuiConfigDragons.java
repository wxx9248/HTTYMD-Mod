...
public class GuiConfigDragons extends GuiConfig
{
    ...
    private static final List<IConfigElement> elements = new ConfigElement(
            HTTYMDMod.getConfig().getConfig().getCategory(Configuration.CATEGORY_GENERAL)).getChildElements();
