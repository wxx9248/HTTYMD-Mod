...
public class ModelNightmare extends ModelDragonOld
{
                ...
                body.addChild(new ModelRendererFactory()
                              {
                                  ...
                                  public ModelRenderer get()
                                  {
                                      ...
                                      Shape1.setTextureSize(textureWidth, textureHeight);
                                      Shape1.mirror = true;
                                      setRotation(Shape1, 0.017453292519943295F, 1.5707963267948966F,
                ...
                body.addChild(new ModelRendererFactory()
                              {
                                  ...
                                  public ModelRenderer get()
                                  {
                                      ...
                                      Shape1.setTextureSize(textureWidth, textureHeight);
                                      Shape1.mirror = true;
                                      setRotation(Shape1, 0.05235987755982988F, 1.5707963267948966F,
                                                  -0.13962634015954636F);
                                      return Shape1;
                                  }
                              }.get()
                ...
                body.addChild(new ModelRendererFactory()
                              {
                                  ...
                                  public ModelRenderer get()
                                  {
                                      ...
                                      Shape1.setTextureSize(textureWidth, textureHeight);
                                      Shape1.mirror = true;
                                      setRotation(Shape1, 0.08726646259971647F, 1.5707963267948966F,
                                                  -0.2617993877991494F);
                                      return Shape1;
                                  }
                              }.get()
                ...
                body.addChild(new ModelRendererFactory()
                              {
                                  ...
                                  public ModelRenderer get()
                                  {
                                      ...
                                      Shape1.setTextureSize(textureWidth, textureHeight);
                                      Shape1.mirror = true;
                                      setRotation(Shape1, -0.03490658503988659F, 1.5707963267948966F,
                                                  -0.4363323129985824F);
                                      return Shape1;
                                  }
                              }.get()
