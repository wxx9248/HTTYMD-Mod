...
/**
 * Reproduces All vanilla tool behaviors (including a hoe, even if it isn't technically a tool) without extending
 * original tools. To detect type of tool item, please use {@link #isToolType(EnumToolType)} instead of instanceof
 *
...
public class ItemToolExtension extends ItemTool implements IRegisterable, IFuelHandler
{
    ...
    public ItemToolExtension(String prefix, Item.ToolMaterial material, Collection<EnumToolType> types)
    {
        ...
        this.setTranslationKey(ItemUtils.findUnlocName(prefix + "_" + material.toString()));
    ...
    public boolean canHarvestBlock(IBlockState state)
    {
                                                     ...
                                                     ? hitBlock != Blocks.IRON_BLOCK && hitBlock != Blocks.IRON_ORE
                                                       ? hitBlock != Blocks.LAPIS_BLOCK && hitBlock != Blocks.LAPIS_ORE
                                                         ? hitBlock != Blocks.REDSTONE_ORE
                                                           ...
                                                           ? state.getMaterial() == Material.ROCK || (state
                                                                                                              .getMaterial() == Material.IRON || state.getMaterial() == Material.ANVIL)
        ...
        if (this.isToolType(EnumToolType.SHOVEL))
            return hitBlock == Blocks.SNOW_LAYER || hitBlock == Blocks.SNOW;
    ...
    {
        return this.getToolTypes() != null ? EnumToolType.getAllNames(this.getToolTypes()) : super
