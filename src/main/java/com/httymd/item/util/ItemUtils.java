...
public class ItemUtils {
	...
	public static ItemArmor.ArmorMaterial addArmorMaterial(String name, int durability, int[] reductionAmounts,
		...
		ItemArmor.ArmorMaterial mat = EnumHelper.addArmorMaterial(name, name, durability, reductionAmounts, enchantability, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 1);
	...
	public static enum EnumArmorType {
		...
		private EnumArmorType(EntityEquipmentSlot slot) {
			this.slot = slot;
		}
	}
}
