 ...
 * points</i>, determining the intervals over which the spline function is defined by the constituent polynomials. The
...
public class PolynomialSplineFunction
{
    ...
    /**
     * The polynomial functions that make up the spline. The first element determines the value of the spline over the
     * first subinterval, the second over the second, etc. Spline function values are determined by evaluating these
     * functions at {@code (x - knot[i])} where i is the knot segment to which x belongs.
     */
    ...
    /**
     * Construct a polynomial spline function with the given segment delimiters and interpolating polynomials. The
     * constructor copies both arrays and assigns the copies to the knots and polynomials properties, respectively.
     *
     ...
     * @return the value.
     *
     * @throws OutOfRangeException if {@code v} is outside of the domain of the spline function (smaller than the
     *                             smallest knot point or larger than the largest knot point).
     */
    ...
    /**
     * Get a copy of the interpolating polynomials array. It returns a fresh copy of the array. Changes made to the copy
     * will not affect the polynomials property.
     *
    ...
    /**
     * Get an array copy of the knot points. It returns a fresh copy of the array. Changes made to the copy will not
